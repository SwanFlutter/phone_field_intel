...
/// Represents a country with its phone number formatting rules and display information.
///
/// This class contains all the necessary information for displaying and validating
/// phone numbers for a specific country, including localized names, flag emoji,
/// country codes, and phone number length constraints.
///
/// ## Properties
///
/// * [name] - The English name of the country
/// * [nameTranslations] - Localized country names in different languages
/// * [flag] - The emoji flag representation of the country
/// * [code] - The ISO 3166-1 alpha-2 country code (e.g., 'US', 'IR')
/// * [dialCode] - The international dialing code without '+' (e.g., '1', '98')
/// * [regionCode] - Additional region code for countries with multiple regions
/// * [minLength] - Minimum valid phone number length (excluding country code)
/// * [maxLength] - Maximum valid phone number length (excluding country code)
///
/// ## Example
///
/// ```dart
/// const usa = Country(
///   name: 'United States',
///   nameTranslations: {'fa': 'ایالات متحده آمریکا'},
///   flag: '🇺🇸',
///   code: 'US',
///   dialCode: '1',
///   regionCode: '',
...
/// );
///
/// print(usa.localizedName('fa')); // ایالات متحده آمریکا
/// print(usa.fullCountryCode); // 1
/// ```
class Country {
  /// The English name of the country.
  final String name;

  /// Localized country names mapped by language code.
  ///
  /// Keys are language codes (e.g., 'en', 'fa', 'ar') and values are
  /// the translated country names in those languages.
  final Map<String, String> nameTranslations;

  /// The emoji flag representation of the country.
  ///
  /// This is used for display on mobile platforms where emoji support is good.
  final String flag;

  /// The ISO 3166-1 alpha-2 country code.
  ///
  /// A two-letter code that uniquely identifies the country (e.g., 'US', 'IR', 'GB').
  final String code;

  /// The international dialing code without the '+' prefix.
  ///
  /// For example, '1' for USA/Canada, '98' for Iran, '44' for UK.
  final String dialCode;

  /// Additional region code for countries with multiple regions.
  ///
  /// Most countries have an empty region code, but some countries like
  /// USA have different codes for different regions.
  final String regionCode;

  /// Minimum valid phone number length (excluding country code).
  ///
  /// This is used for validation to ensure the phone number is not too short.
  final int minLength;

  /// Maximum valid phone number length (excluding country code).
  ///
  /// This is used for validation to ensure the phone number is not too long.
  final int maxLength;
  ...
  /// Returns the complete country code including region code.
  ///
  /// This combines [dialCode] and [regionCode] to form the complete
  /// international dialing code for the country.
  ///
  /// Example:
  /// ```dart
  /// print(usa.fullCountryCode); // "1" (dialCode: "1", regionCode: "")
  /// ```
  String get fullCountryCode {
    return dialCode + regionCode;
  }

  /// Returns a formatted display version of the country code.
  ///
  /// If the country has a region code, it returns the dial code and region code
  /// separated by a space. Otherwise, it returns just the dial code.
  ///
  /// Example:
  /// ```dart
  /// print(country.displayCC); // "1" or "1 234" if region code exists
  /// ```
  ...
  /// Returns the localized name of the country for the given language code.
  ///
  /// If a translation exists for the given [languageCode], it returns the
  /// translated name. Otherwise, it falls back to the English [name].
  ///
  /// [languageCode] should be a valid language code like 'en', 'fa', 'ar', etc.
  ///
  /// Example:
  /// ```dart
  /// print(iran.localizedName('fa')); // "ایران"
  /// print(iran.localizedName('en')); // "Iran"
  /// print(iran.localizedName('de')); // "Iran" (fallback to English)
  /// ```
